...
def new():
    ...
    return render_template("adopters/new.jinja2", form=form)
...
def edit(adopter_id):
    ...
    return render_template("adopters/edit.jinja2", form=form, adopter=adopter)
